<template>
  <div id="weekly">
    ...
    <a-table :data="pageData" :pagination="false" :scroll="{x: 'auto',y: 'auto',}">
      <template #columns>
        <a-table-column align="center" :width="100" title="周报ID" data-index="weekly_id"/>
        <a-table-column align="center" :width="130" title="用户姓名" data-index="username"/>
        <a-table-column align="center" :width="120" title="周报标题" data-index="title"/>
        <a-table-column align="center" :width="120" title="周报内容" data-index="content">
        ...
        <a-table-column align="center" :width="280" title="提交时间" data-index="weekly_time"/>
    ...
    <a-modal v-model:visible="ModifyFlag" @ok="ModifyFun" title="修改用户信息" @cancel="OffModify">
      <a-form :model="ModifyForm" ref="FormModify" :rules="Rules">
        ...
        <a-form-item field="weekly_time" label="提交日期" path="weekly_time">
          <a-date-picker v-model="ModifyForm.weekly_time" show-time format="YYYY-MM-DD HH:mm:ss"/>
        </a-form-item>
          ...
          <div style="display: flex; align-items: center; width: 100%">
            <n-space>
              ...
              <n-date-picker style="width: 200px"
                              placeholder="请选择时间"
                              v-model:formatted-value="value.weekly_time"
...
<script setup>
import From from "@/page/Weekly/FromComponents.vue";
import PaginationComponents from "@/components/PaginationComponents.vue";
import {computed, onMounted, reactive, ref} from "vue";
import {addWeekly, delWeekly, getWeekly, modifyWeekly} from "@/request/api";
...
const ModifyInfo = (record) => {
  ModifyForm.weekly_id = record.weekly_id
  ...
  ModifyForm.weekly_time = record.weekly_time
...
// 编辑关闭
const OffModify = () => {
  ModifyForm.weekly_id = null
  ModifyForm.content = ""
  ModifyForm.title = ""
  ModifyForm.username = ""
  ModifyForm.enable = ""
  ModifyForm.weekly_time = ""
}
